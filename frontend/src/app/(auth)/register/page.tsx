    ...
    <div className="w-full max-w-md mx-auto mt-20 p-6">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="text-zinc-400">Join AI Video Studio today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1" htmlFor="fullName">
              Full Name (Optional)
            </label>
            <input
              id="fullName"
          ...
          <div>
            ...
            <input
              ...
              minLength={8}
            />
            <p className="text-[10px] text-zinc-500 mt-1">Must be at least 8 characters long</p>
          </div>
        ...
        <p className="mt-6 text-center text-zinc-400 text-sm">
          ...
          <Link href="/login" className="text-violet-400 hover:text-violet-300 underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </motion.div>
